...
class RepositoryTest {
    ...
    @Test
    fun getLatestRatesSuccessWithoutDbUpdateTest() {
    ...
    @Test
    fun getLatestRatesEmptyWithoutDbUpdateTest() {
    ...
    @Test
    fun getLatestRatesSuccessWithDbUpdateTest() {
        val json =
    ...
    @Test
    fun getLatestRatesEmptyWithDbUpdateTest() {
        val dbUpdateTime = Date(1500241092536)
        Mockito.`when`(localDataSource.getDbUpdateTime()).thenReturn(dbUpdateTime)
        val json = "{}"
        val jsonObject = JsonParser().parse(json).asJsonObject
    ...
    @Test
    fun getLatestRatesErrorWithDbUpdateTest() {
        val message = "Uncaught Error"
        val dbUpdateTime = Date(1500241092536)
        Mockito.`when`(localDataSource.getDbUpdateTime()).thenReturn(dbUpdateTime)
        remoteDataSource.stub {
        ...
        runBlocking {
            ...
            assertTrue(secondItem.message.equals(message))
        }
    }
